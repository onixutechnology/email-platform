...
import EmailOpensDashboard from './components/EmailOpensDashboard';
      ...
      <EmailProvider>
        <Router>
          <Routes>
            ...
            <Route path="/emails/opens" element={<ProtectedOpens />} />
